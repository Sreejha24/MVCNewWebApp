...
using MVCNewWebApp.Models.Views;
...
namespace MVCNewWebApp.Controllers
{
    public class PeopleController : Controller
    {
        ...
        {
            ViewData["AddressID"] = new SelectList(_context.Set<PAddresss>(), "AddressId", "AddressId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("PersonID,FirstName,LastName,Email,Mobile,AddressID")] Person person)
        {
            ...
            ViewData["AddressID"] = new SelectList(_context.Set<PAddresss>(), "AddressId", "AddressId", person.AddressID);
            return View(person);
        }
